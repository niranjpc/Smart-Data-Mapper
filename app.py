...
# --- Provider to Reference Auto-Mapping ---
        ...
        try:
            ...
            for _, row in rag_df.iterrows():
                ...
                audit_rows.append({
                    ...
                    "Healthcare Data Column": mapped_provider_col if mapped_provider_col else "",
            ...
            with col2:
                st.metric("📋 Healthcare Data Columns", stats['total_provider_columns'])
            with col3:
